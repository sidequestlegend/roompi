...
public class OwnSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private int FPS = 24; // by default 4 fps
    ...
    public void openCamera() {
        ...
        if (frameSize != null) {
            ...
            Camera.Size minPreviewSize = (lastElementWidth > firstElementWidth) ? supportedPreviewSizes.get(2) : supportedPreviewSizes.get(supportedPreviewSizes.size() - 1);
