...
public class MainActivity extends Activity {
    ...
    final static Handler h = new Handler(new Handler.Callback() {
        @Override
...
//	    size.y = size.y/2;
        ...
        opponentView.setScaleType(ImageView.ScaleType.CENTER_CROP);
        ...
        Thread ndsthread = new Thread(new Runnable(){@Override public void run() { new NDS(MainActivity.this);}});
        ndsthread.start();
        ...
        roombaView.setOnTouchListener(new View.OnTouchListener() {
            @Override
    ...
    public void roombaConnect(final String ip){
        try {
            Log.d("NDS","new connection opening");
            roombaclient = new WSClient(new URI("ws://"+ip+":65432"), new Draft_10()){
                ...
                public void onOpen(ServerHandshake handshakedata) {
                    ...
                    IPCamera cam1 = new IPCamera(Uri.parse("http://"+ip+":8080/?action=stream"), MainActivity.this);
